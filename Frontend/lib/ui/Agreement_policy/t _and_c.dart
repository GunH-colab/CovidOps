          ...
          child:Column(
              children:<Widget>[
                ...
                Container(
                  ...
                  margin: EdgeInsets.all(20.0),
                  padding: EdgeInsets.all(12.0),
                  child: Text('''If you would like to contact us to understand more about this Agreement or wish to contact us concerning any matter relating to it, you may do so via the contact form or send an email to covidops2021@gmail.com. This document was last updated on May 5, 2021''',
                    maxLines: 20,
                    textAlign: TextAlign.left,
                    style: TextStyle(color:Colors.black,fontSize:Helper.textSize),),
                ),
