...
class MyTextPage extends StatelessWidget {
          ...
          child:Column(
              children:<Widget>[
                Container(
                  ...
                  child: Text("Privacy policy",style: TextStyle(color:Colors.black,fontSize:Helper.headSize,fontWeight:FontWeight.bold),textAlign:TextAlign.left),
                ),
                Container(
                  alignment: Alignment.centerLeft,
                  margin: EdgeInsets.all(20.0),
                ...
                Container(
                  ...
                  margin: EdgeInsets.all(20.0),
                  padding: EdgeInsets.all(12.0),
                  child: Text("Automatic collection of information",style: TextStyle(color:Colors.black,fontSize:Helper.headSize,fontWeight:FontWeight.bold),),
                ),
                Container(
                  alignment: Alignment.centerLeft,
                  margin: EdgeInsets.all(20.0),
                ...
                Container(
                  ...
                  margin: EdgeInsets.all(20.0),
                  padding: EdgeInsets.all(12.0),
                  child: Text("Collection of personal information",style: TextStyle(color:Colors.black,fontSize:Helper.headSize,fontWeight:FontWeight.bold),),
                ),
                Container(
                  alignment: Alignment.centerLeft,
                  margin: EdgeInsets.all(20.0),
  ...
  6.  Any other materials you willingly submit to us such as articles, images, feedback, etc''',
                ...
                Container(
                  ...
                  child: Text("Use and processing of collected information",
                      style: TextStyle(color:Colors.black,fontSize:Helper.headSize,fontWeight:FontWeight.bold),
                      textAlign:TextAlign.left),
                ),
                Container(
                  alignment: Alignment.centerLeft,
  ...
  8. Run and operate the Mobile Application and Services''',
                ...
                Container(
                  ...
                  TextStyle(color:Colors.black,fontSize:Helper.headSize,fontWeight:FontWeight.bold),
                      textAlign:TextAlign.left),
                ),
                Container(
                  alignment: Alignment.centerLeft,
                ...
                Container(
                  ...
                  margin: EdgeInsets.all(20.0),
                  padding: EdgeInsets.all(12.0),
                  child: Text("The rights of users",style: TextStyle(color:Colors.black,fontSize:Helper.headSize,fontWeight:FontWeight.bold),textAlign:TextAlign.left),
                ),
                Container(
                  alignment: Alignment.centerLeft,
                  margin: EdgeInsets.all(20.0),
                ...
                Container(
                  ...
                  margin: EdgeInsets.all(20.0),
                  padding: EdgeInsets.all(12.0),
                  child: Text("Transfer of information",style: TextStyle(color:Colors.black,fontSize:Helper.headSize,fontWeight:FontWeight.bold),textAlign:TextAlign.left),
                ),
                Container(
                  alignment: Alignment.centerLeft,
                  margin: EdgeInsets.all(20.0),
                ...
                Container(
                  ...
                  margin: EdgeInsets.all(20.0),
                  padding: EdgeInsets.all(12.0),
                  child: Text("The right to object to processing",style: TextStyle(color:Colors.black,fontSize:Helper.headSize,fontWeight:FontWeight.bold),textAlign:TextAlign.left),
                ),
                Container(
                  alignment: Alignment.centerLeft,
                  margin: EdgeInsets.all(20.0),
                ...
                Container(
                  ...
                  margin: EdgeInsets.all(20.0),
                  padding: EdgeInsets.all(12.0),
                  child: Text("Data protection rights under GDPR",style: TextStyle(color:Colors.black,fontSize:Helper.headSize,fontWeight:FontWeight.bold),textAlign:TextAlign.left),
                ),
                Container(
                  alignment: Alignment.centerLeft,
                  margin: EdgeInsets.all(20.0),
  ...
  6.  You also have the right to withdraw your consent at any time where the Operator relied on your consent to process your Personal Information.''',
                ...
                Container(
                  ...
                  margin: EdgeInsets.all(20.0),
                  padding: EdgeInsets.all(12.0),
                  child: Text("California privacy rights",style: TextStyle(color:Colors.black,fontSize:Helper.headSize,fontWeight:FontWeight.bold),textAlign:TextAlign.left),
                ),
                Container(
                  alignment: Alignment.centerLeft,
                  margin: EdgeInsets.all(20.0),
                ...
                Container(
                  ...
                  margin: EdgeInsets.all(20.0),
                  padding: EdgeInsets.all(12.0),
                  child: Text("How to exercise these rights",style: TextStyle(color:Colors.black,fontSize:Helper.headSize,fontWeight:FontWeight.bold),textAlign:TextAlign.left),
                ),
                ...
                Container(
                  ...
                  margin: EdgeInsets.all(20.0),
                  padding: EdgeInsets.all(12.0),
                  child: Text("Privacy of children",style: TextStyle(color:Colors.black,fontSize:Helper.headSize,fontWeight:FontWeight.bold),textAlign:TextAlign.left),
                ),
                Container(
                  alignment: Alignment.centerLeft,
                  margin: EdgeInsets.all(20.0),
                ...
                Container(
                  ...
                  margin: EdgeInsets.all(20.0),
                  padding: EdgeInsets.all(12.0),
                  child: Text("Information security",style: TextStyle(color:Colors.black,fontSize:Helper.headSize,fontWeight:FontWeight.bold),textAlign:TextAlign.left),
                ),
                Container(
                  alignment: Alignment.centerLeft,
                  margin: EdgeInsets.all(20.0),
                ...
                Container(
                  ...
                  margin: EdgeInsets.all(20.0),
                  padding: EdgeInsets.all(12.0),
                  child: Text("Data breach",style: TextStyle(color:Colors.black,fontSize:Helper.headSize,fontWeight:FontWeight.bold),textAlign:TextAlign.left),
                ),
                Container(
                  alignment: Alignment.centerLeft,
                  margin: EdgeInsets.all(20.0),
